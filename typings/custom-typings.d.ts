...
interface GlobalEnvironment {
  ...
  SystemJS: SystemJS;
  System: SystemJS;
  eConfirm: (message?: string) => Promise<boolean>;
  eAlert: (message?: string) => Promise<boolean>;
  LS: LocalForage;
}
...
declare var rtn: { data: any[] };
declare var eConfirm: (message?: string) => Promise<boolean>;
declare var eAlert: (message?: string) => Promise<boolean>;
declare var LS: LocalForage;
...
declare type PromiseFunc = () => Promise<any>;
